...
Beim Erstellen eines neuen Projekts startet ein Assistent, der die Grundkonfiguration abfragt: Soll WiFi eingeplant werden? Welche Produktlinie (z.B. Enterprise E7)? Braucht es Kameras oder [Zutrittskontrolle](/de/blog/unifi-access-zutrittskontrolle)? Basierend auf den Antworten schlägt das Tool eine erste Geräteliste vor, inklusive Gateway und Switch.
...
Neben WLAN lässt sich auch die Kameraplanung im Design Center abbilden. Man wählt ein Kameramodell (z.B. G5 Bullet, [G5 Turret Ultra](/de/blog/g5-turret-ultra-kamera-test)) und platziert es auf dem Grundriss. Das Tool zeigt den Blickwinkel und den abgedeckten Bereich an. So erkennt man auf einen Blick, ob es tote Winkel gibt.
...
*Haben Sie Fragen zu Netzwerkplanung? [Kontaktieren Sie uns](/de/kontakt) für eine kostenlose Erstberatung.*
