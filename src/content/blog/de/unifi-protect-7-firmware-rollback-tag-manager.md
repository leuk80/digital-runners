---
title: "UniFi Protect 7.0: Firmware-Rollback, Tag Manager und Custom Layouts"
description: "UniFi Protect 7.0 bringt Firmware-Rollback, Custom Camera Layouts, Tag Manager, Bewegungspfade und bildbasierte Suche. Alle Neuerungen und Bugfixes im Überblick."
pubDate: 2026-03-09
lang: de
...
## 2. Dashboard: Echtzeit-Bitrate und AI-Monitoring

Im Dashboard gibt es jetzt eine Anzeige der **Echtzeit-Bitrate**. So sieht man auf einen Blick, wie viel Bandbreite die Kameras aktuell verbrauchen – im Testvideo von Mactelecom Networks lag der Wert bei etwa 25 bis 35 Mbit/s.

Wer einen **AI Key** im Einsatz hat, bekommt zusätzlich die Edge-AI-Latenz angezeigt. Das umfasst:

- Verarbeitete Detektionen und durchschnittliche Latenzwerte
- **Object Indexing** (im Test: 5'663 Objekte in 24 Stunden)
- **AI Summary**, **Speech-to-Text**, **LPR** und **Face ID** für Legacy-Kameras
- CPU-Auslastung des AI Keys (im Test bei nur 5%)

Die einzelnen AI-Dienste lassen sich bei Bedarf auch gezielt deaktivieren – zum Beispiel LPR für Legacy-Kameras, wenn man das nicht benötigt.
...
## 4. Tag Manager: Kameras gruppieren
...
## 5. Bewegungspfade in der Wiedergabe
...
## 6. Bildbasierte Suche in Find Anything
...
Im Video-Test von Mactelecom Networks wurde ein Thumbnail-Bild hochgeladen und das System hat die Person sowohl mit als auch ohne Mütze erkannt. Das Ganze setzt einen **AI Key mit aktivierter Computer-Vision-Erweiterung** voraus.

***

## 7. AI-Policies und Offsite Archiving
