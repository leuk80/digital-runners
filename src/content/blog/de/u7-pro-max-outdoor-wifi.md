...
**Preis:** 279€ im EU-Store – inkl. PoE++ Injector, mastmontierbar, 2-3 Tage Lieferzeit Schweiz. Perfekt für UCG Ultra/UDM-Setups mit Outdoor-Bedarf.

**Das Problem, das er löst:**
```
❌ Indoor APs: 20m Range, Regen → Ausfall
❌ Consumer Mesh: 300Mbps, keine VLANs
❌ Kabelverlegung: 5000CHF Graben
...
```
Profi-Installation:
├── Mast (3-5m): 50CHF Baumarkt
├── PoE++ Injector (60W): Im Keller/Schuppen
├── Cat6 Kabel: UV-beständig, 50m Rolle 25€
...
| AP | Preis | WiFi | Coverage | Weather | PoE |
|----|-------|------|----------|---------|-----|
| **U7 Pro Max Outdoor** | 279€ | WiFi 7 | 300m² | IP67 | PoE++ |
| U6 Mesh Pro | 179€ | WiFi 6 | 200m² | IPX5 | PoE+ |
| U7 Outdoor | 229€ | WiFi 7 | 250m² | IP67 | PoE+ |
| Netgear Orbi 970 | 1499€ | WiFi 7 | 400m² | IP66 | Proprietär |
...
├── eu.store.ui.com: 279€ (2-3 Tage)
├── Digitec.ch: 318CHF (next day)
├── Amazon.de: 289€ (Prime)

Outdoor Starter Bundle (799€):
├── U7 Pro Max Outdoor (279€)
├── 2x G5 Bullet (238€)
├── USW Flex Mini 2.5G (109€)
├── PoE++ Injector (49€)
├── 50m Cat6 Outdoor (24€)
```
...
```
Kosten: 1x U7 Pro Max Outdoor = 279€
Ersparnis:
├── 2x weniger APs (-200€)
├── Stabiles Smart Home (-500€ Support)
├── 50% höhere Gastzufriedenheit (Restaurant)
→ Payback: 6-12 Monate
```
...
2. **Outdoor Installation** – Zürich Service (299CHF)
